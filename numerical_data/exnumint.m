...
% Number of points for Trapezoidal rule and Simpson's rule = N+1
% Number of points for Gauss-Legendre rule = N
% N must be even for Simpson's rule
% Try N = 4, 8, 16, 32, 64 and see what happens to the error
N = 8;

% Width of N equal width intervals
h = (b-a) / N;            

% Points and values for plotting integrand
